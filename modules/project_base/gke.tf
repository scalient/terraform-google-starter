...
resource "google_container_cluster" "_" {
  ...
  depends_on = [
    ...
    google_project_iam_binding.base_project_container_service_agent,
    google_project_iam_binding.network_project_container_host_service_agent_user,
    google_project_iam_binding.network_project_compute_network_user,
    google_project_iam_binding.network_project_compute_network_user,
