...
resource "google_project_iam_binding" "network_project_container_host_service_agent_user" {
...
resource "google_project_iam_binding" "network_project_compute_network_user" {
  project = local.network_project
...
resource "google_project_iam_binding" "network_project_compute_security_admin" {
  project = local.network_project
