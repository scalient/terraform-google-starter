...
EOS
    ...
    Utilities.create_terraform_backend_and_migrate(self, Pathname.new("backend.tf.json"), bucket, prefix: "bootstrap")
  end

  Utilities.create_terraform_backend_and_migrate(self, Pathname.new("backend.tf.json"), bucket)
